...
///  This is a wrapper around the VaultCw20Contract
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub struct VaultCw20Contract {
    pub addr: Addr,
    pub init: InstantiateMsg,
}

impl TestingContract<InstantiateMsg, ExecuteMsg, QueryMsg> for VaultCw20Contract {
    ...
    fn new(app: &mut App, env: &Env, msg: Option<InstantiateMsg>) -> Self {
        ...
        let addr = Self::instantiate(app, code_id, "vault_cw20", &init);
        Self { addr, init }
    }
