...
Restaked Bitcoin LSTs are key to the SatLayer ecosystem, providing the necessary cryptoeconomic security for Services.
...
- Providing economic incentives for proper operation

Services require infrastructure support because building and maintaining a robust, secure validation network
...
<Callout type="info">
  **Services without operations?**<br/>
  Services in SatLayer can exist without a need for operations in the traditional sense.
...
specific application or protocol without proper guidance, generally we expect Services to provide clear documentation.
...
- **Create fair crypto-economic models**: Aligning the interests of both parties through well-designed crypto-economic models
