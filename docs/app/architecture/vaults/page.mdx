...
<Callout type="info">
  This is technical documentation for BVS operators and technical users.
</Callout>
...
<Callout type="default">
  All vaults are designed to be upgradeable.
  They also implement queued withdrawals with time locks to ensure system stability during active validation periods.
</Callout>
