...
# SatLayer Core Contracts (EVM)

SatLayer contracts provide a simple, modular set of contracts to connect [Services](/architecture/services) and [Operators](/architecture/operators), manage vault-based restaking, and coordinate slashing.

At a glance, we have the following the following contracts:

### SatLayer Registry ([ISLAYRegistryV2](/evm/contracts/ISLAYRegistryV2.sol))
...
### SatLayer Router ([ISLAYRouterV2](/evm/contracts/ISLAYRouterV2.sol), [ISLAYRouterSlashingV2](/evm/contracts/ISLAYRouterSlashingV2.sol))
...
### SatLayer Rewards ([ISLAYRewardsV2](/evm/contracts/ISLAYRewardsV2.sol))
...
### SatLayer VaultFactory ([ISLAYVaultFactoryV2](/evm/contracts/ISLAYVaultFactoryV2.sol))
- Factory for creating SLAY Vaults.
- Delegated to Operators to manage the vaults.

### SatLayer Vault ([ISLAYVaultV2](/evm/contracts/ISLAYVaultV2.sol))
