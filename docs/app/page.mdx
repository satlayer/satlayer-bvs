...
| Feature                                            | Description                                                                                                                             |
|:---------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [Vaults](/architecture/vaults)                  | The primary interface for users to deposit assets, receive shares, and withdraw assets when needed.                                     |
| [Services](/architecture/services)              | Applications or protocols that utilize the SatLayer ecosystem for validation and security.                                              |
| [Operators](/architecture/operators)            | Operators are the validators, infrastructure providers, and operational backbone of the ecosystem.                                      |
| [Programmable Slashing](/architecture/slashing) | A programmable interface for services to execute slashing to penalize malicious behavior or perform defaulting swaps.                   |
| [Rewards](/architecture/rewards)                | A system for services to distribute rewards to operators and restakers, ensuring fair and regular compensation for their contributions. |
...
<Cards num={2}>
  ...
  <Cards.Card arrow title="Developing BVS on SatLayer" href="/architecture/services">
