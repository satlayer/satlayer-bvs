...
Services should call the `DistributeRewards` function on the [`bvs-rewards`](/cosmwasm/contracts/rewards) contract
...
- Appropriate allowances are granted to the [`bvs-rewards`](/cosmwasm/contracts/rewards) contract
