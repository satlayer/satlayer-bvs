...
Together with [Operators](/getting-started/operators), Services form the backbone of the SatLayer ecosystem.
...
See [Programmable Slashing](/getting-started/slashing) for more indepth information on the slashing mechanism.
