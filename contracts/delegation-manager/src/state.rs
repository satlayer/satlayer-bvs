...
pub const STRATEGY_WITHDRAWAL_DELAY_BLOCKS: Map<&Addr, Uint64> =
...
pub const CUMULATIVE_WITHDRAWALS_QUEUED: Map<&Addr, u128> =
    Map::new("cumulative_withdrawals_queued");
pub const OWNER: Item<Addr> = Item::new("owner");
pub const DELEGATION_APPROVER_SALT_SPENT: Map<(&Addr, &str), bool> =
