...
use common::bvsdriver::ExecuteMsg as BvsDriverExecuteMsg;
...
use common::statebank::ExecuteMsg as StateBankExecuteMsg;
...
pub const PAUSED_OPERATOR_REGISTER_DEREGISTER_TO_BVS: u8 = 0;
