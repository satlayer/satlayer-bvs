...
func NewService() *Service {
	...
	metricsIndicators := transactionprocess.NewPromIndicators(prometheus.NewRegistry(), "slash")
	...
	slashManager := api.NewSlashManagerImpl(chainIO, conf.C.Contract.Slash).WithGasLimit(2000000)
